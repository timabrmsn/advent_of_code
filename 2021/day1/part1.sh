...
# lights (because of course it is), and it even has an
# experimental antenna that should be able to track the keys
# if you can boost its signal strength high enough; there's
# a little meter that indicates the antenna's signal strength
