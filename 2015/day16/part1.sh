...
# 500, for sanity) gave you the gift. You open the present and, as
# luck would have it, good ol' Aunt Sue got you a My First Crime
...
grep -vE 'children: [^3]|cats: [^7]|samoyeds: [^2]|pomeranians: [^3]|akitas: [^0]|vizslas: [^0]|goldfish: [^5]|trees: [^3]|cars: [^2]|perfumes: [^1]' input.txt 